...
(function probeImg(){ const im=new Image(); im.onload=()=>{USE_IMG=true; try{if(state)render();}catch(e){} if($("screenDeck").classList.contains("on")) renderDeckBuilder();}; im.onerror=()=>{USE_IMG=false; try{if(state)render();}catch(e){} if($("screenDeck").classList.contains("on")) renderDeckBuilder();}; im.src=IMG_BASE+"card_000.png"; })();
(function init(){
